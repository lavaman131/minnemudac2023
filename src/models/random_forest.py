...
from features import FEATURES, RF_PARAMS
...
# reg = RandomForestRegressor(criterion='friedman_mse', random_state=42)
...
for i, (train_index, val_index) in enumerate(kf.split(X)):
    print(f"Fold {i}:")
    reg = RandomForestRegressor(**RF_PARAMS, criterion='friedman_mse', random_state=42)
